...
class Rossmann( object):
    ...
    def __init__( self ):
        ...
        self.home_path = '/media/wellington/Documentos/Driver/python/Comunidade_ds/Repositorios/Ds_em_producao/data-science-producao/'
        #Carregar os arquivos salvo 
...
#Variaveis citricas (Calculo do seno e cosseno)
...
# day_of_week
        ...
        col_selected =[  'store', 'promo', 'store_type', 'assortment', 'competition_distance',
                        'competition_open_since_month', 'competition_open_since_year', 'promo2', 'promo2_since_week', 'promo2_since_year',
                        'competition_time_month', 'promo_time_week', 'month_cos', 'month_sin', 'day_sin', 'day_cos', 'week_of_year_cos',
                        'week_of_year_sin', 'day_of_week_sin', 'day_of_week_cos']
    ...
    def get_prediction (self, model, original_data, test_data):
        ...
        #Join pred into the originaç data
